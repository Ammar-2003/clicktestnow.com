                ...
                data.leaderboard.forEach((item, index) => {
                    ...
                    leaderboardContent.innerHTML += `
                        <tr class="leaderboard-item ${rankClass}">
                            ...
                            <td class="leaderboard-score">${parseFloat(item.score).toFixed(1)} CPS</td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Test variables - 15 seconds for CPS test
    let testDuration = 15;
    ...
    function startTest() {
        ...
        const countdownInterval = setInterval(() => {
            ...
            if (countdown > 0) {
                ...
                // Updated to 15-second text for CPS test
                statusDisplay.innerHTML = `
    ...
    function endTest() {
        ...
        let tip = "";
        if (cps < 6) {
            tip = "Focus on developing a consistent rhythm and try different clicking techniques to improve your speed.";
        } else if (cps < 8) {
            tip = "Good speed! Try to maintain consistency throughout the entire 15 seconds to improve your score.";
        } else if (cps < 10) {
            tip = "Excellent speed! Work on building stamina to maintain your pace for the full duration.";
        } else if (cps < 12) {
            tip = "Impressive speed! You're among the top clickers. Focus on small improvements to reach the next level.";
        } else {
            tip = "Elite level clicking! You're in the top tier of clickers. Maintain this performance and experiment with advanced techniques.";
        }
