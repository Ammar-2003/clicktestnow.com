document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("/get-spacebar-leaderboard10/")
        .then(res => res.json())
        .then(data => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Test variables - 10 seconds for spacebar test
    let testDuration = 10;
    ...
    // ⭐ NEW VARIABLE to prevent continuous counting
    ...
    // Global spacebar handler - PREVENT DEFAULT SCROLLING
    ...
    document.addEventListener('keydown', function(e) {
        if (e.code === 'Space') {
            ...
            // Register a single press during the active test
            if (testState === 'active') {
                registerPress();
            }
        }
    ...
    // ⭐ Spacebar key release handler - NEW
    ...
    function startTest() {
        ...
        const countdownInterval = setInterval(() => {
            ...
            if (countdown > 0) {
                ...
                // Updated to 10-second text for spacebar test
                statusDisplay.innerHTML = `
    ...
    function endTest() {
        ...
        // For 10-second spacebar test, stamina is calculated differently
        const staminaScoreValue = Math.min(100, consistencyValue * 0.8 + (pressCount > 100 ? 20 : 0));
        ...
        if (pps < 9) {
            ...
            tip = "Work on building stamina to maintain your pressing technique for the full 10 seconds.";
        } else if (pps < 18) {
        ...
        statusDisplay.innerHTML = `
            ...
            <div>Total Presses in 10 Seconds</div>
    ...
    // Save score to database - UPDATED URL
    function saveScoreToDatabase(score, presses) {
        fetch('/save-spacebar-score10/', {
            method: 'POST',
            headers: {
    ...
    function showAchievementAnimation(rank, score, presses) {
        ...
        overlay.innerHTML = `
            <div class="achievement-content">
                ...
                <div class="achievement-rank">Rank: #${rank} | Score: ${score} Presses | PPS: ${(score/10).toFixed(1)}</div>
    ...
    // Update leaderboard with latest data - UPDATED URL
