...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Test variables - changed to 20 seconds for CPS test
    let testDuration = 20;
    ...
    function startTest() {
        ...
        const countdownInterval = setInterval(() => {
            ...
            if (countdown > 0) {
                ...
                // Updated to 20-second text for CPS test
                statusDisplay.innerHTML = `
    ...
    function endTest() {
        ...
        // For 20-second test, stamina is calculated differently
        ...
        let tip = "";
        if (cps < 6) {
            tip = "Focus on maintaining a consistent rhythm rather than trying to click as fast as possible in short bursts.";
        } else if (cps < 8) {
            tip = "Try to relax your hand and arm more. Tension can reduce your clicking speed and endurance.";
        } else if (cps < 10) {
            tip = "Work on building stamina to maintain your clicking speed for the full 20 seconds.";
        } else if (cps < 12) {
            tip = "Your clicking technique is good. Experiment with different techniques to find what works best.";
        } else if (cps < 15) {
            tip = "You're an expert clicker! Focus on consistency to reach the next level.";
        } else {
