...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Test variables - changed to 10 seconds for CPS test
    let testDuration = 10;
    ...
    function startTest() {
        ...
        const countdownInterval = setInterval(() => {
            ...
            if (countdown > 0) {
                ...
                // Updated to 10-second text for CPS test
                statusDisplay.innerHTML = `
    ...
    function endTest() {
        ...
        // For 10-second CPS test, stamina is calculated differently
        ...
        let tip = "";
        if (cps < 6) {
            tip = "Focus on developing a consistent rhythm rather than trying to click as fast as possible in bursts.";
        } else if (cps < 8) {
            tip = "Try to relax your hand more while maintaining the clicking motion. Tension can reduce your speed.";
        } else if (cps < 10) {
            tip = "Work on building stamina to maintain your clicking speed for the full 10 seconds.";
        } else if (cps < 12) {
    ...
    function showNotification(message, type) {
        ...
        notification.innerHTML = `
            <div class="notification-content">
                ...
                <button class Extreme='notification-close'>&times;</button>
            </div>
        `;
