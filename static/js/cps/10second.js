document.addEventListener('DOMContentLoaded', function() {
    ...
    // Test variables - set to 10 seconds for 10-second test
    let testDuration = 10;
    ...
    // Auth logic for test area - IDENTICAL TO 5-SECOND TEST
    if (testArea) {
    ...
    function updateTimer() {
        ...
        // Format time like 10.0, 9.9 ... 0.1, 0.0
    ...
    function endTest() {
        ...
        // For 10-second test, stamina is calculated differently - higher threshold
        const staminaScoreValue = Math.min(100, consistencyValue * 0.8 + (clickCount > 120 ? 20 : 0));
        ...
        // Generate improvement tip - adjusted for 10-second test
        let tip = "";
        if (cps < 6) {
            tip = "Focus on clicking with a consistent rhythm rather than just speed. Try to find a comfortable pace you can maintain for 10 seconds.";
        } else if (cps < 8) {
            tip = "Try using two fingers alternately (butterfly clicking) to increase your speed without losing consistency over 10 seconds.";
        } else if (cps < 10) {
            tip = "Your clicking speed is good. Work on maintaining this pace consistently throughout the entire 10 seconds.";
        } else if (cps < 12) {
            tip = "You're an advanced clicker! Consider learning jitter clicking techniques to push your speed even higher over 10 seconds.";
        } else if (cps < 15) {
            tip = "Excellent endurance! Focus on maintaining your peak speed throughout the entire 10-second duration.";
        } else {
    ...
    // Reset the test - IDENTICAL TO 5-SECOND TEST
    function resetTest() {
    ...
    function showAchievementAnimation(rank, score, clicks) {
        ...
        if (rank === 1) {
            ...
            message = `You've achieved the #1 spot globally with ${score.toFixed(1)} CPS! Your 10-second clicking endurance is unmatched.`;
        } else if (rank === 2) {
            icon = '🥈';
            title = 'SILVER MEDALIST!';
            message = `Amazing endurance! You're the 2nd best clicker worldwide with ${score.toFixed(1)} CPS over 10 seconds.`;
        } else if (rank === 3) {
            icon = '🥉';
            title = 'BRONZE MEDALIST!';
            message = `Outstanding stamina! You've secured the 3rd position globally with ${score.toFixed(1)} CPS over 10 seconds.`;
        } else if (rank <= 4) {
            icon = '⭐';
            title = 'TOP 4 ELITE!';
            message = `Incredible endurance! You're among the top 4 clickers worldwide with ${score.toFixed(1)} CPS over 10 seconds.`;
        } else if (rank <= 10) {
            icon = '🏆';
            title = 'TOP 10 MASTER!';
            message = `Excellent stamina! You've made it to the top 10 with ${score.toFixed(1)} CPS over 10 seconds. Keep pushing for the top!`;
        }
