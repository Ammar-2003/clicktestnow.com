...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Test variables - changed to 5 seconds for jitter test
    let testDuration = 5;
    ...
    function endTest() {
        ...
        if (clickTimes.length > 5) {
            ...
            if (cpsRate > 14) {
                technique = "Advanced Jitter";
                techniqueTags = '<span class="technique-tag">High Frequency</span><span class="technique-tag">Arm Vibration</span>';
            } else if (cpsRate > 10) {
                technique = "Basic Jitter";
                techniqueTags = '<span class="technique-tag">Medium Frequency</span><span class="technique-tag">Wrist Vibration</span>';
            } else if (cpsRate > 7) {
        ...
        // Generate improvement tip for jitter clicking
        let tip = "";
        if (cps < 9) {
            tip = "Focus on creating a consistent vibration motion with your arm muscles rather than just your wrist.";
        } else if (cps < 12) {
            tip = "Try to relax your arm more while maintaining the vibration. Tension can reduce your jitter speed.";
        } else if (cps < 15) {
            tip = "Work on building stamina to maintain your jitter technique for the full 5 seconds.";
        } else if (cps < 18) {
            tip = "Your jitter technique is good. Experiment with different arm positions to find what works best.";
        } else if (cps < 21) {
            tip = "You're an expert jitter clicker! Focus on consistency to reach the next level.";
        } else {
            tip = "You're at an elite jitter clicking level! Maintain this performance and consider streaming your technique.";
        }
        ...
        statusDisplay.innerHTML = `
            ...
            <div>Final Jitter CPS Score</div>
        ...
        const testResult = {
            ...
            jitterFrequency: reactionTimeValue,
    ...
    function showAchievementAnimation(rank, score, clicks) {
        ...
        if (rank === 1) {
            ...
            message = `You've achieved the #1 spot globally with ${score.toFixed(1)} CPS! Your jitter clicking skills are unmatched.`;
        } else if (rank === 2) {
            icon = '🥈';
            title = 'SILVER MEDALIST!';
            message = `Amazing performance! You're the 2nd best jitter clicker worldwide with ${score.toFixed(1)} CPS.`;
        } else if (rank === 3) {
            icon = '🥉';
            ...
            icon = '⭐';
            title = 'TOP 4 ELITE!';
            message = `Incredible! You're among the top 4 jitter clickers worldwide with ${score.toFixed(1)} CPS.`;
        } else if (rank <= 10) {
            icon = '🏆';
            title = 'TOP 10 MASTER!';
