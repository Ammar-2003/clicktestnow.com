document.addEventListener('DOMContentLoaded', function() {
    ...
    // Test variables - set to 2 seconds for 2-second test
    let testDuration = 2;
    ...
    // Auth logic for test area - IDENTICAL TO 1-SECOND TEST
    if (testArea) {
    ...
    function endTest() {
        ...
        // For 2-second test, stamina is calculated differently
        const staminaScoreValue = Math.min(100, consistencyValue * 0.8 + (clickCount > 25 ? 20 : 0));
        ...
        let tip = "";
        if (cps < 7) {
            tip = "Focus on clicking with a consistent rhythm rather than just speed. Try to find a comfortable pace you can maintain.";
        } else if (cps < 10) {
            tip = "Try using two fingers alternately (butterfly clicking) to increase your speed without losing consistency.";
        } else if (cps < 13) {
            tip = "Your clicking speed is good. Work on maintaining this pace consistently throughout the entire 2 seconds.";
        } else if (cps < 16) {
            tip = "You're an advanced clicker! Consider learning jitter clicking techniques to push your speed even higher.";
        } else {
    ...
    // Reset the test - IDENTICAL TO 1-SECOND TEST
    function resetTest() {
