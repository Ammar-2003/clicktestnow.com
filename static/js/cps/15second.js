document.addEventListener('DOMContentLoaded', function() {
    ...
    // Test variables - set to 15 seconds for 15-second CPS test
    let testDuration = 15;
    ...
    function endTest() {
        ...
        // For 15-second CPS test, stamina is calculated differently
        const staminaScoreValue = Math.min(100, consistencyValue * 0.8 + (clickCount > 100 ? 20 : 0));
        ...
        let tip = "";
        if (cps < 6) {
            tip = "Focus on developing a consistent rhythm and try different clicking techniques to improve your speed and stamina.";
        } else if (cps < 8) {
            tip = "Good speed! Focus on maintaining consistency throughout the entire 15 seconds to improve your endurance score.";
        } else if (cps < 10) {
            tip = "Excellent speed! Work on building stamina to maintain your pace for the full duration.";
        } else if (cps < 12) {
            tip = "Impressive speed and endurance! You're among the top clickers. Focus on small improvements to reach elite level.";
        } else if (cps < 15) {
            tip = "Elite level clicking! You're in the top tier of clickers. The average is 13-15 CPS - keep pushing your limits!";
        } else {
            tip = "Master level performance! You're in rare air reserved for true masters. Continue perfecting your technique.";
        }
    ...
    function showAchievementAnimation(rank, score, clicks) {
        ...
        if (rank === 1) {
            ...
            message = `You've achieved the #1 spot globally with ${score.toFixed(1)} CPS over 15 seconds! Your endurance and speed are unmatched.`;
        } else if (rank === 2) {
            icon = '🥈';
            title = 'SILVER MEDALIST!';
            message = `Amazing endurance! You're the 2nd best 15-second clicker worldwide with ${score.toFixed(1)} CPS.`;
        } else if (rank === 3) {
            icon = '🥉';
            ...
            icon = '⭐';
            title = 'TOP 4 ELITE!';
            message = `Incredible endurance! You're among the top 4 15-second clickers worldwide with ${score.toFixed(1)} CPS.`;
        } else if (rank <= 10) {
            icon = '🏆';
            title = 'TOP 10 MASTER!';
            message = `Excellent stamina! You've made it to the top 10 with ${score.toFixed(1)} CPS. Keep pushing for the top!`;
        }
